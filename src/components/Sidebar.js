    ...
    const menuItems = [
        {
            ...
            links: [
                { label: t("warehouse.subLinks.items"), path: '/items/list' },
                { label: t("warehouse.subLinks.createItem"), path: '/items/form' },
                { label: t("warehouse.subLinks.repositories"), path: '/items/edit-profit-percentages' },
                { label: t("warehouse.subLinks.createRepository"), path: '/items/edit-profit-percentages' },
            ]
        },
        // {
        //     head: 'المبيعات',
        //     links: [
        //         { label: 'ادارة الفواتير', path: '/invoice/s/list' },
        //         { label: 'اٍنشاء فاتوره', path: '/invoice/s/form' },
        //     ]
        // },
        // {
        //     head: 'المشتريات',
        //     links: [
        //         { label: 'ادارة الفواتير', path: '/invoice/p/list' },
        //         { label: 'اٍنشاء فاتوره', path: '/invoice/p/form' },
        //     ]
        // },
        // {
        //     head: 'المخازن',
        //     links: [
        //         { label: 'ادارة المخازن', path: '/repository/list' },
        //         { label: 'اٍنشاء مخزن', path: '/repository/form' },
        //     ]
        // },
        // {
        //     head: 'العملاء/الموردين',
        //     links: [
        //         { label: 'اداره العملاء و الموردين', path: '/client-supplier/list' },
        //         { label: 'اٍنشاء عميل/مورد', path: '/client-supplier/form' },
        //     ]
        // },
        // {
        //     head: 'المالية',
        ...
        //         { label: 'اضافة', path: 'http://localhost:8000/api/payment/payments/?ownerid=-1' },
        //         { label: 'نفقات', path: '/finance/expenses/' },
        //         { label: 'اضافة', path: 'http://localhost:8000/api/payment/expenses/?ownerid=-1' },
        //         { label: 'قائمة المديونيات', path: '/finance/credit-owners-list' },
        //     ]
        // },
        // {
        //     head: 'التقارير',
        //     links: [
        //         { label: 'الاسطوانات المعاد تعبئتها', path: '/report/refilled-cylinders' },
        //         { label: 'المدفوعات خلال فترة', path: '/report/payments' },
        //     ]
        // },
        // {
        //     head: 'خاص بالاصناف التي يمكن اعادة تعبئتها',
        //     links: [
        //         { label: 'الاصناف المعاد تعبئتة', path: 'http://localhost:8000/api/refillable-sys/refilled-items/' },
        //         { label: 'الاصناف 2 المعاد تعبئتة', path: 'refillable-sys/refilled-list/' },
        //         { label: 'انشاء;', path: 'refillable-sys/refilled-form/' },
        //         { label: 'الاسطوانات لدي العملاء;', path: 'refillable-sys/cans-owners-has/' },
        //     ]
        // },
        // {
        //     head: 'الاعدادات',
        //     links: [
        //         { label: 'واجهة 2', path: 'http://localhost:8000/admin/' },
        //         { label: 'قائمة الاصناف التي تم تصحيح اعدادها', path: 'http://localhost:8000/api/items/quantity-errors-list/' },
        //         { label: 'سجل الطلبات', path: 'http://localhost:8000/api/requests-logs/' },
        //     ]
        // },
        // {
        //     head: 'Logout',
            ...
            <aside id="logo-sidebar" className="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white borderR border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700" aria-label="Sidebar">
                <div className="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
                    <ul className="space-y-2 font-medium">
                        ...
                        {menuItems.map((obj, i) => (
                            <li key={i}>
                                <button type="button" className="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700" aria-controls={obj.head} data-collapse-toggle={obj.head}>
                                    {obj.icon}
                                ...
                                <ul id={obj.head} className="hidden py-2 space-y-2">
                                    {obj.links.map((link, j) => (
                                        <li key={j}>
                                            <Link href={link.path} className="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
                                                {link.label}
                                            </Link>
                                        </li>
                                    ))}
