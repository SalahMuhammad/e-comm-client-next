...
export default function Toggle({ value, toggleAction, toggleValues, className = "" }) {
    ...
    return (
        ...
        >
            ...
            <span
                className={`flex items-center mr-2 transition-transform duration-300 ease-in-out transform origin-center group-hover:scale-110 ${isChanging ? "animate-spin-slow" : ""
                    }`}
            >
                {status ? (
            ...
            <span className={`transition-opacity duration-300 ease-in-out`}>
                {status ? toggleValues.fulfilled : toggleValues.unfulfilled}
            </span>
