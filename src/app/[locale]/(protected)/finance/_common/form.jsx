...
function MyForm({ initialData, type }) {
    ...
    return (
        <GenericFormShell
            ...
            obj={initialData}
            t={t}
            redirectPath={`/finance/${type}/list`}
            isModal={false}
            customTitle={`${initialData?.id ? t("finance.fields.update") : t("finance.fields.transaction")} ${initialData?.hashed_id ? "#" + initialData.hashed_id : ""}`.trim()}
            showIdField={false}
        >
