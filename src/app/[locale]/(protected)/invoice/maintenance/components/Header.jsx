...
import { STATUS_CONFIG } from './utility';
import { Link, usePathname, useRouter } from '@/i18n/navigation';


// ─── Status filter tabs ────────────────────────────────────────────────────────
const ALL_STATUSES = ['all', 'pending', 'maintained', 'rejected', 'mcomplete'];
...
function Header() {
    ...
    // Create a function that creates a new query string with the updated param
    ...
    // Example: Trigger this when your filter changes
    ...
    return (
        <div className="sticky top-0 z-1 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 shadow-sm">
