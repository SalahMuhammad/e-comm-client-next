...
import { StatusBadge } from '../../list/components/utilit';
...
const MaintenanceView = ({ data }) => {
    ...
    const handleQuickClose = async () => {
        setClosing(true);
        try {
            const res = await fetch(`/api/maintenance/${data.id}/`, {
                method: 'PUT',
            ...
            <div className="sticky top-0 z-20 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 shadow-sm">
                <div className="max-w-4xl mx-auto px-4 py-4 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <button
                            onClick={() => router.push(`/invoice/maintenance/form/${data.hashed_id}`)}
            ...
            <div className="max-w-4xl mx-auto px-4 pt-6 space-y-6">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm p-6">
                    ...
                    <div className="mt-6 grid grid-cols-2 md:grid-cols-4 gap-5 pt-5 border-t border-gray-100 dark:border-gray-700">
                        ...
                        <InfoField icon={UserIcon}     label={t('handledBy')}    value={data._by_first_name} />
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            <p className="text-sm font-medium text-gray-900 dark:text-gray-100">
                                                {part.spare_part_name || `#${part.spare_part}`}
                                            </p>
                                            <p className="text-xs text-gray-400 dark:text-gray-500">
                                                {t('partId')} {part.spare_part}
                                            </p>
                                        </div>
                                    </div>
